...
namespace Reaqtive.Scheduler
{
        ...
        where TTime : IComparable<TTime>
    {
        ...
        public bool Invoke(YieldToken yieldToken)
        {
            ...
            {
                //
                // NB: The call to OnCompleted needs to come last, after accounting has taken place. It is typically
                //     wired to remove the work item from work lists. We don't consider this to be part of the task's
                //     execution time.
                //
