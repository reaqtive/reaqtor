...
namespace Reaqtive.Scheduler
{
    ...
    public struct Duration : IEquatable<Duration>
    {
        ...
        /// </remarks>
        public long CycleTime => _cycleTime;
        ...
        /// </remarks>
        public TimeSpan ElapsedTime => ToTimeSpan(_tickCount);
        ...
        {
            _cycleTime = left._cycleTime + right._cycleTime,
            _tickCount = left._tickCount + right._tickCount,
        };
        ...
        public override int GetHashCode() => Combine(
            _tickCount.GetHashCode(),
            _cycleTime.GetHashCode()
        );
    }
