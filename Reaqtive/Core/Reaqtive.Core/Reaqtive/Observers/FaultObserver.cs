...
namespace Reaqtive
{
    ...
    public class FaultObserver<TSource>(Func<Exception> getFault) : IObserver<TSource>
    {
        private readonly Func<Exception> _getFault = getFault ?? throw new ArgumentNullException(nameof(getFault));
