...
namespace Reaqtive
{
    ...
    public abstract class VersionedUnaryOperator<TParam, TResult>(TParam parent, IObserver<TResult> observer) : UnaryOperator<TParam, TResult>(parent, observer), IVersioned
    {
