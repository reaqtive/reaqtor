...
namespace Reaqtive.Tasks
{
    ...
    /// </remarks>
    public sealed class YieldableActionTask<T>(Func<T, YieldToken, bool> action, T state) : ISchedulerTask, IYieldableSchedulerTask
    {
        /// <summary>
        /// The action to execute.
        /// </summary>
        private readonly Func<T, YieldToken, bool> _action = action ?? throw new ArgumentNullException(nameof(action));
