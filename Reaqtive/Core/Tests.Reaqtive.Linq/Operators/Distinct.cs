...
namespace Test.Reaqtive.Operators
{
    ...
    public partial class Distinct : OperatorTestBase
    {
        ...
        [TestMethod]
        public void Distinct_Comparer_AllDifferent()
        {
            Run(client =>
            {
                ...
                var res = client.Start(() =>
                    xs.Distinct(new FuncComparer<int>((x, y) => false))
                );
        ...
        [TestMethod]
        public void Distinct_Comparer_AllEqual()
        {
            Run(client =>
            {
                var xs = client.CreateHotObservable(
                ...
                var res = client.Start(() =>
                    xs.Distinct(new FuncComparer<int>((x, y) => true))
                );
        ...
        [TestMethod]
        public void Distinct_KeySelectorThrows()
        {
            Run(client =>
            {
                ...
                var res = client.Start(() =>
                    xs.Distinct(new Func<int, int>(x => { throw ex; }))
                );
        ...
        [TestMethod]
        public void Distinct_ComparerThrows()
        {
            Run(client =>
            {
                var ex = new Exception();
                ...
                var res = client.Start(() =>
                    xs.Distinct(new ThrowComparer<int>(ex))
                );
        ...
        [TestMethod]
        public void Distinct_KeySelector_Comparer()
        {
            Run(client =>
            {
                var xs = client.CreateHotObservable(
                ...
                var res = client.Start(() =>
                    xs.Distinct(x => x / 2, new FuncComparer<int>((x, y) => x % 3 == y % 3))
                );
        ...
        [TestMethod]
        public void Distinct_SaveAndReload()
        {
            ...
            var res = Scheduler.Start(
                () =>
                    xs.Distinct().Apply(Scheduler, checkpoints)
            );
