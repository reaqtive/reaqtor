...
{
    public sealed class SequentialAssertionTestServiceProvider(IEqualityComparer<ServiceOperation> comparer, params ServiceOperation[] operations) : AssertionTestServiceProvider, IDisposable
    {
