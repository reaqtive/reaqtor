...
{
    public abstract class AssertionTestReliableEngineProvider : TestReliableEngineProvider
    {
        ...
        public override void AssertCreateObserver(Uri streamUri)
        {
            AssertCore(new CreateObserver(streamUri));
        }

        //protected override void AssertOnStarted(Uri observerUri)
        //{
        //    AssertCore(new OnStarted(observerUri));
        //}
