...
namespace Reaqtor.Metadata
{
    ...
    /// </summary>
    /// <remarks>The IDisposable implementation will undefine the object represented by the definition.</remarks>
    public interface IReactiveDefinedResource : IReactiveResource
    {
        /// <summary>
