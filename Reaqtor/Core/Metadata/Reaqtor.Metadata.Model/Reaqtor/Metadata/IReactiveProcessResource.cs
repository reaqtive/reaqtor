...
namespace Reaqtor.Metadata
{
    ...
    /// </summary>
    /// <remarks>The IDisposable implementation will stop the process, e.g. cancelling a subscription or deleting a subject.</remarks>
    public interface IReactiveProcessResource : IReactiveResource, IDisposable
    {
        /// <summary>
