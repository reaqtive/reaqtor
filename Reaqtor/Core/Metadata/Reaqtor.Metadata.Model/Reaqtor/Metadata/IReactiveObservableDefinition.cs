...
namespace Reaqtor.Metadata
{
    ...
    /// </summary>
    public interface IReactiveObservableDefinition : IReactiveDefinedResource
    {
        /// <summary>
        ...
        /// </remarks>
        IReactiveQbservable<T> ToObservable<T>();
        ...
        /// does not have to provide data operations, as is expected from the client library proxy objects.
        /// </remarks>
        Func<TArgs, IReactiveQbservable<TResult>> ToObservable<TArgs, TResult>();
    }
}
