...
{
    public sealed class MyAsyncReactiveQubject<TInput, TOutput> : AsyncReactiveQubjectBase<TInput, TOutput>
    {
        ...
        protected override Task OnNextAsyncCore(TInput value, CancellationToken token) => throw new NotImplementedException();
