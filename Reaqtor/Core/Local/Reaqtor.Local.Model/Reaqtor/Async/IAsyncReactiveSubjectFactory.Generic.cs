...
namespace Reaqtor
{
    ...
    public interface IAsyncReactiveSubjectFactory<TInput, TOutput>
    {
        /// <summary>
        ...
        Task<IAsyncReactiveSubject<TInput, TOutput>> CreateAsync(Uri streamUri, object state = null, CancellationToken token = default);
    }
    ...
    public interface IAsyncReactiveSubjectFactory<TInput, TOutput, TArgs>
    {
        /// <summary>
        /// Creates a new subject with the specified stream URI.
        /// </summary>
        ...
        /// <param name="token">Token to observe for cancellation of the request.</param>
        /// <returns>Task returning a subject object that can be used to send and receive data on the stream, or an exception if the creation request was unsuccessful.</returns>
        Task<IAsyncReactiveSubject<TInput, TOutput>> CreateAsync(Uri streamUri, TArgs argument, object state = null, CancellationToken token = default);
    }
}
