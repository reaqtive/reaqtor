...
namespace Reaqtor.QueryEngine
{
    ...
    internal class CooperativeLookupReactiveEntityCollection<TKey, TValue, TArg>(IReactiveEntityCollection<TKey, TValue> local, TryLookup<TArg, TKey, TValue> tryLookup, TArg arg) : IReactiveEntityCollection<TKey, TValue>
    {
        private readonly IReactiveEntityCollection<TKey, TValue> _local = local;
        private readonly TryLookup<TArg, TKey, TValue> _tryLookup = tryLookup;
