...
namespace Tests.Reaqtor.QueryEngine
{
    ...
    public class SerializerTests
    {
        ...
        public void Serializer_TypedRoundtrips()
        {
            ...
            AssertRoundtrip<sbyte>(42);
            AssertRoundtrip<short>(42);
            AssertRoundtrip<ushort>(42);
            AssertRoundtrip<int>(42);
            AssertRoundtrip<uint>(42U);
            AssertRoundtrip<long>(42L);
            AssertRoundtrip<ulong>(42UL);
            AssertRoundtrip<float>(3.14F);
            AssertRoundtrip<double>(3.14D);
            AssertRoundtrip<decimal>(4.95M);
            AssertRoundtrip<bool>(true);
            AssertRoundtrip<char>('c');
            AssertRoundtrip<DateTime>(new DateTime(1983, 2, 11, 12, 34, 56));
            AssertRoundtrip<DateTimeOffset>(new DateTimeOffset(1983, 2, 11, 12, 34, 56, TimeSpan.FromHours(8)));
            AssertRoundtrip<TimeSpan>(new TimeSpan(1, 2, 3, 4, 5));
            AssertRoundtrip<Guid>(Guid.NewGuid());
            AssertRoundtrip<string>("bar");
        ...
        [TestMethod]
        public void Serializer_TypedRoundtrips_ConstantExpression()
        {
            foreach (var o in new object[]
            {
                ...
                true,
                'c',
                new DateTime(1983, 2, 11, 12, 34, 56),
                new DateTimeOffset(1983, 2, 11, 12, 34, 56, TimeSpan.FromHours(8)),
            ...
            {
                AssertRoundtrip(Expression.Constant(o), new ExpressionEqualityComparer());
            }
        }
