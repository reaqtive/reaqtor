...
#pragma warning restore IDE0060 // Remove unused parameter
        ...
        public void CheckpointSelectManySanityCheck()
        {
            ...
            Assert.IsTrue(out1.WaitForCount(2, TimeSpan.FromSeconds(30)));
            AssertResultSequence(out1, new int[] { 8, 9 });

            in2s.OnNext(11);

            Assert.IsTrue(out1.WaitForCount(4, TimeSpan.FromSeconds(30)));
...
#pragma warning restore IDE0079
        ...
        [TestMethod, Ignore("Store contains references to types using old assembly names and namespaces; these need to be updated.")]
        public void CheckpointRecoveryMitigation_SubscriptionCompilationError_Remove_GarbageCollect()
        {
            ...
            var qe = CreateQueryEngine(trace);
