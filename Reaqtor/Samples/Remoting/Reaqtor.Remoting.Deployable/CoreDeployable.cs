...
{
    public partial class CoreDeployable : IDeployable
    {
        private readonly bool _doUndefine;

        public CoreDeployable(bool doUndefine = false)
        {
        ...
        protected virtual async Task UndefineOperators(ReactiveClientContext context)
        {
            ...
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.Contains.Element), CancellationToken.None)).ConfigureAwait(false);
            ...
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.DefaultIfEmpty.NoArgument), CancellationToken.None)).ConfigureAwait(false);
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.DefaultIfEmpty.DefaultValue), CancellationToken.None)).ConfigureAwait(false);
            ...
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.Distinct.NoArgument), CancellationToken.None)).ConfigureAwait(false);
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.Distinct.Func), CancellationToken.None)).ConfigureAwait(false);
            ...
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.ElementAt.Index), CancellationToken.None)).ConfigureAwait(false);
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.ElementAtOrDefault.Index), CancellationToken.None)).ConfigureAwait(false);
            ...
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.IgnoreElements.NoArgument), CancellationToken.None)).ConfigureAwait(false);
            ...
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.LastAsync.NoArgument), CancellationToken.None)).ConfigureAwait(false);
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.LastAsync.Func), CancellationToken.None)).ConfigureAwait(false);
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.LastOrDefaultAsync.NoArgument), CancellationToken.None)).ConfigureAwait(false);
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.LastOrDefaultAsync.Func), CancellationToken.None)).ConfigureAwait(false);
            ...
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.SingleAsync.NoArgument), CancellationToken.None)).ConfigureAwait(false);
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.SingleAsync.Func), CancellationToken.None)).ConfigureAwait(false);
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.SingleOrDefaultAsync.NoArgument), CancellationToken.None)).ConfigureAwait(false);
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.SingleOrDefaultAsync.Func), CancellationToken.None)).ConfigureAwait(false);
        ...
        protected virtual async Task DefineOperators(ReactiveClientContext context)
        {
            ...
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, T, bool>(new Uri(Client.Constants.Observable.Contains.Element), (source, element) => source.AsSync().Contains(element, DataTypeEqualityComparer<T>.Default).AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            ...
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, T>(new Uri(Client.Constants.Observable.DefaultIfEmpty.NoArgument), source => source.AsSync().DefaultIfEmpty().AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, T, T>(new Uri(Client.Constants.Observable.DefaultIfEmpty.DefaultValue), (source, defaultValue) => source.AsSync().DefaultIfEmpty(defaultValue).AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            ...
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, T>(new Uri(Client.Constants.Observable.Distinct.NoArgument), source => source.AsSync().Distinct(DataTypeEqualityComparer<T>.Default).AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, Expression<Func<T, R>>, T>(new Uri(Client.Constants.Observable.Distinct.Func), (source, keySelector) => source.AsSync().Distinct(keySelector, DataTypeEqualityComparer<R>.Default).AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            ...
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, int, T>(new Uri(Client.Constants.Observable.ElementAt.Index), (source, index) => source.AsSync().ElementAt(index).AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, int, T>(new Uri(Client.Constants.Observable.ElementAtOrDefault.Index), (source, index) => source.AsSync().ElementAtOrDefault(index).AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            ...
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, T>(new Uri(Client.Constants.Observable.IgnoreElements.NoArgument), source => source.AsSync().IgnoreElements().AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            ...
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, T>(new Uri(Client.Constants.Observable.LastAsync.NoArgument), source => source.AsSync().LastAsync().AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, Expression<Func<T, bool>>, T>(new Uri(Client.Constants.Observable.LastAsync.Func), (source, predicate) => source.AsSync().LastAsync(predicate).AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, T>(new Uri(Client.Constants.Observable.LastOrDefaultAsync.NoArgument), source => source.AsSync().LastOrDefaultAsync().AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, Expression<Func<T, bool>>, T>(new Uri(Client.Constants.Observable.LastOrDefaultAsync.Func), (source, predicate) => source.AsSync().LastOrDefaultAsync(predicate).AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            ...
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, T>(new Uri(Client.Constants.Observable.SingleAsync.NoArgument), source => source.AsSync().SingleAsync().AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, Expression<Func<T, bool>>, T>(new Uri(Client.Constants.Observable.SingleAsync.Func), (source, predicate) => source.AsSync().SingleAsync(predicate).AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, T>(new Uri(Client.Constants.Observable.SingleOrDefaultAsync.NoArgument), source => source.AsSync().SingleOrDefaultAsync().AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, Expression<Func<T, bool>>, T>(new Uri(Client.Constants.Observable.SingleOrDefaultAsync.Func), (source, predicate) => source.AsSync().SingleOrDefaultAsync(predicate).AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
        ...
        {
            if (undefine == null)
                throw new ArgumentNullException(nameof(undefine));

            try
            {
                await undefine().ConfigureAwait(false);
            }
