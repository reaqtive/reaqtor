...
namespace Reaqtor.Remoting.Deployable
{
    public partial class CoreDeployable : IDeployable
    {
        ...
        protected virtual async Task UndefineOperators(ReactiveClientContext context)
        {
            ...
            await TryUndefine(() => context.UndefineObservableAsync(new Uri(Client.Constants.Observable.Contains.ElementComparer), CancellationToken.None)).ConfigureAwait(false);
        ...
        protected virtual async Task DefineOperators(ReactiveClientContext context)
        {
            ...
            await context.DefineObservableAsync<IAsyncReactiveQbservable<T>, T, bool>(new Uri(Client.Constants.Observable.Contains.Element), (source, element) => source.AsSync().Contains(element).AsAsync(), null, CancellationToken.None).ConfigureAwait(false);
