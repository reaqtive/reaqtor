...
namespace Reaqtor.Shebang.Client
{
    ...
    public class ClientContext : ReactiveClientContext
    {
        ...
        [KnownResource("nucleus://shebang/observables/timer")]
        public IAsyncReactiveQbservable<DateTimeOffset> Timer(TimeSpan period) => GetObservable<TimeSpan, DateTimeOffset>(new Uri("nucleus://shebang/observables/timer"))(period);

        [KnownResource("nucleus://shebang/observers/cout")]
        public IAsyncReactiveQbserver<string> ConsoleOut => GetObserver<string>(new Uri("nucleus://shebang/observers/cout"));
