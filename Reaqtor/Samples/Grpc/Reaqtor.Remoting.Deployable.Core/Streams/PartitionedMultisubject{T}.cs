...
#pragma warning restore IDE0034 // Simplify 'default' expression
        ...
        public ISubscription Subscribe(IObserver<T> observer, IReadOnlyList<TypeErasedKeyBinding<T>> bindings)
        {
            ...
            return (ISubscription)s_subscribeTyped.MakeGenericMethod(fst.KeyType).Invoke(this, [observer, fst, lst]);
        }
...
#pragma warning restore CA2213
    ...
    private PartitionDelegator Delegator => field ??= new CustomPartitionDelegator(Expression);
    ...
    public Expression Expression
    {
        get
        {
            if (field == null)
            {
                ...
                field = Expression.New(s_newProxy, Expression.Constant(_uri));
            }
