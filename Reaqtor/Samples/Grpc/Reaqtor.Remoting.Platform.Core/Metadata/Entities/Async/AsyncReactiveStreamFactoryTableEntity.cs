...
namespace Reaqtor.Remoting.Metadata
{
    ...
    /// </summary>
    public class AsyncReactiveStreamFactoryTableEntity : AsyncReactiveDefinedResourceTableEntity, IAsyncReactiveStreamFactoryDefinition
    {
        /// <summary>
        /// Default constructor, required by the Azure Table query provider.
        /// </summary>
        public AsyncReactiveStreamFactoryTableEntity()
        {
        }

        /// <summary>
        /// Creates a new table entity representing a stream factory with the specified URI and expression representation.
        /// </summary>
        /// <param name="uri">URI identifying the stream factory represented by the table entity.</param>
        /// <param name="expression">Expression representation of the stream factory.</param>
        /// <param name="state">The state.</param>
        public AsyncReactiveStreamFactoryTableEntity(Uri uri, Expression expression, object state)
