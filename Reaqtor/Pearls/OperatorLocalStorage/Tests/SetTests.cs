                ...
                Operation.Sequence(
                    ...
                    Operation.Sequence(
                        ...
                        Operation.Sequence(
                            ...
                            // Argument checking
                            //
                            assert.ThrowsException<ArgumentNullException>().When(set.UnionWith(null)),
                        ...
                        Operation.Sequence(
                            ...
                            // Argument checking
                            //
                            assert.ThrowsException<ArgumentNullException>().When(set.ExceptWith(null)),
                        ...
                        Operation.Sequence(
                            ...
                            // Argument checking
                            //
                            assert.ThrowsException<ArgumentNullException>().When(set.IntersectWith(null)),
                        ...
                        Operation.Sequence(
                            ...
                            // Argument checking
                            //
                            assert.ThrowsException<ArgumentNullException>().When(set.SymmetricExceptWith(null)),
