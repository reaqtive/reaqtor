...
{
    /// <summary>
    /// Interface representing a persisted sorted dictionary.
    /// </summary>
    /// <typeparam name="TKey">The type of the keys in the persisted sorted dictionary.</typeparam>
    /// <typeparam name="TValue">The type of the values in the persisted sorted dictionary.</typeparam>
    /// <remarks>This interface type does not inherit from <see cref="IPersistedDictionary{TKey, TValue}"/> in order to guarantee type uniqueness per persisted artifact.</remarks>
    public interface IPersistedSortedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>, IPersisted
    {
        /// <summary>
