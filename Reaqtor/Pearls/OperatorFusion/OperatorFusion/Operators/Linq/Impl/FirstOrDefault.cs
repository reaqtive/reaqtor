...
{
    internal sealed class FirstOrDefaultFactory : IFusionOperator
    {
        public Type OutputType { get; set; }

        public HoistOperations Hoist => HoistOperations.OnNext | HoistOperations.OnError | HoistOperations.OnCompleted;
