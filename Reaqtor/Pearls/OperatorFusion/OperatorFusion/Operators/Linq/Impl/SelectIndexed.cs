...
//
// Implementation of the Select operator (with index parameter) using fusion.
//
// BD - October 2014
//
...
{
    internal sealed class SelectIndexedFactory : IFusionOperator
    {
            ...
            return value =>
            {
                ...
                return
                    Expression.Block(
                        ...
                        Expression.TryCatch(
                            Expression.Block(
                                Expression.Assign(res, Expression.Invoke(Selector, value, index)),
