...
namespace System.Linq.Expressions
{
    ...
    /// </summary>
    public sealed class DefaultExpressionSlim : ExpressionSlim
    {
        internal DefaultExpressionSlim(TypeSlim type)
        {
            Type = type;
        }
        ...
        /// <summary>
        /// Gets the type of the default value represented by the expression.
        /// </summary>
