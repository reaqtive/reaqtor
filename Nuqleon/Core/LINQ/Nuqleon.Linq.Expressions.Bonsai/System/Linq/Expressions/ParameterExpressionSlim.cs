...
{
    // PERF: Consider introducing specializations for primitive (slim) types and/or parameters without a Name.

    // REVIEW: IsByRef support is missing here.
    ...
    {
        internal ParameterExpressionSlim(TypeSlim type, string name)
        {
            Type = type;
            Name = name;
        }
