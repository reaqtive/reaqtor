...
namespace Tests.System.Linq.Expressions.Optimizers
{
    ...
    public partial class ExpressionOptimizerTests
    {
        ...
        internal static void AreEqual(Expression expected, Expression actual)
        {
            Assert.IsTrue(new ExpressionEqualityComparer(() => new ExpressionComparator()).Equals(actual, expected), $"{actual} != ${expected}");
        }
