...
#pragma warning restore IDE0034 // Simplify 'default' expression
    ...
    public void Tree_Children()
    {
        ...
        var node2 = new Tree<int>(92, [node1, leaf3]);
  ...
  92(
    ...
    44()
        ...
        Assert.AreEqual(expected.Replace("\r", string.Empty), node3.ToString(indent: 0).Replace("\r", string.Empty));
    }
    ...
    public void Tree_FormatStrings()
    {
        ...
        var res = node1.ToString(indent: 0);
        var expected =
@"{1}{2}{0}(
  {0} {{1}}(), 
  {{{2}}}()
...
#pragma warning restore IDE0034 // Simplify 'default' expression
    ...
    public void Tree_Update3()
    {
        ...
        var tree1 = new Tree<int>(1, leaf1, leaf2);
        var tree2 = ((ITree)tree1).Update([leaf2, leaf3]);
...
@"1(
  ...
  <null>, 
  3()
)".Replace("\r", string.Empty), tree.ToString(indent: 0).Replace("\r", string.Empty));
