...
namespace Nuqleon.Reflection.Emit
{
    public class PropertyBuilder : PropertyInfo
    {
        ...
        public override MethodInfo[] GetAccessors(bool nonPublic) => throw new NotSupportedException(); // NB: Same as BCL code.

        public override MethodInfo GetGetMethod(bool nonPublic) => _property.GetGetMethod(nonPublic).Unwrap();

        public override ParameterInfo[] GetIndexParameters() => throw new NotSupportedException(); // NB: Same as BCL code.
