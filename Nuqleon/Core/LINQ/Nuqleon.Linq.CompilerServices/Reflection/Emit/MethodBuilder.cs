...
namespace Nuqleon.Reflection.Emit
{
    public class MethodBuilder : MethodInfo
    {
        ...
        public override ICustomAttributeProvider ReturnTypeCustomAttributes => null; // NB: Same as BCL code.

        public override MethodAttributes Attributes => _method.Attributes;

        public override RuntimeMethodHandle MethodHandle => throw new NotSupportedException(); // NB: Same as BCL code.
        ...
        public override object Invoke(object obj, BindingFlags invokeAttr, Binder binder, object[] parameters, CultureInfo culture) => throw new NotSupportedException(); // NB: Same as BCL code.
