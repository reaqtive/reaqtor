...
namespace Nuqleon.Json.Serialization
{
    public partial class FastJsonSerializerFactory
    {
        ...
        private sealed class Serializer<T>(EmitStringAction<T> emitterString, FastJsonSerializerFactory.EmitterStringBuilder builderString, EmitWriterAction<T> emitterWriter, FastJsonSerializerFactory.EmitterWriterBuilder builderWriter) : SerializerBase<T>(emitterString, emitterWriter)
        {
            private readonly EmitterContext _context = new EmitterContext(builderString, builderWriter);
