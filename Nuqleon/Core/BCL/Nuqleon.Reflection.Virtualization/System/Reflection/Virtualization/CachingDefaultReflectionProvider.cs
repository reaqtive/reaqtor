...
namespace System.Reflection
{
    ...
    public class CachingDefaultReflectionProvider : DefaultReflectionProvider, IClearable
    {
        ...
        private readonly IMemoizedDelegate<Func<Assembly, IEnumerable<Type>>> _assemblyGetDefinedTypes;
        ...
        public CachingDefaultReflectionProvider(IMemoizer memoizer, ReflectionCachingOptions options)
        {
            ...
            {
                _assemblyGetDefinedTypes = memoizer.Memoize<Assembly, IEnumerable<Type>>(a => a.DefinedTypes);
        ...
        public override IEnumerable<Type> GetDefinedTypes(Assembly assembly) => _assemblyGetDefinedTypes != null ? _assemblyGetDefinedTypes.Delegate(assembly) : base.GetDefinedTypes(assembly);
        ...
        private struct MakeGenericTypeParams : IEquatable<MakeGenericTypeParams>
        {
            ...
            public bool Equals(MakeGenericTypeParams other)
            {
                ...
                if (other.Arguments.Length != count)
                {
                    return false;
                }
            ...
            {
                var res = Definition.GetHashCode();

                var count = Arguments.Length;

                for (var i = 0; i < count; i++)
                {
                    res = res * 17 + Arguments[i].GetHashCode();
                }
        ...
        private struct MakeGenericMethodParams : IEquatable<MakeGenericMethodParams>
        {
            ...
            public bool Equals(MakeGenericMethodParams other)
            {
                if (other.Definition != Definition)
                {
                    return false;
