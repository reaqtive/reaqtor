...
namespace System.Reflection
{
    ...
    public class DefaultReflectionProvider : ReflectionProvider
    {
        /// <summary>
        /// Gets the singleton instance of the default reflection provider.
        /// </summary>
        public static readonly DefaultReflectionProvider Instance = new DefaultReflectionProvider();
        ...
        public override Assembly Load(string assemblyString) => Assembly.Load(assemblyString);
        ...
        /// <returns>The loaded assembly.</returns>
        public override Assembly LoadFile(string path) => Assembly.LoadFile(path);
        ...
        /// <param name="assemblyFile">The name or path of the file that contains the manifest of the assembly.</param>
        /// <returns>The loaded assembly.</returns>
        public override Assembly UnsafeLoadFrom(string assemblyFile) => Assembly.UnsafeLoadFrom(assemblyFile);
        ...
        public override Module LoadModule(Assembly assembly, string moduleName, byte[] rawModule, byte[] rawSymbolStore) => assembly.LoadModule(moduleName, rawModule, rawSymbolStore);
        ...
        public override Type GetType(string typeName, bool throwOnError, bool ignoreCase) => Type.GetType(typeName, throwOnError, ignoreCase);
        ...
        /// <param name="ignoreCase">true to perform a case-insensitive search for <paramref name="typeName" />, false to perform a case-sensitive search for <paramref name="typeName" />. </param>
        /// <returns>The type with the specified name. If the type is not found, the <paramref name="throwOnError" /> parameter specifies whether null is returned or an exception is thrown. In some cases, an exception is thrown regardless of the value of <paramref name="throwOnError" />. See the Exceptions section. </returns>
        public override Type GetType(string typeName, Func<AssemblyName, Assembly> assemblyResolver, Func<Assembly, string, bool, Type> typeResolver, bool throwOnError, bool ignoreCase) => Type.GetType(typeName, assemblyResolver, typeResolver, throwOnError, ignoreCase);
        ...
        public override Type GetTypeFromCLSID(Guid clsid, string server, bool throwOnError) => Type.GetTypeFromCLSID(clsid, server, throwOnError);
        ...
        public override Type GetTypeFromProgID(string progID, string server, bool throwOnError) => Type.GetTypeFromProgID(progID, server, throwOnError);
        ...
        public override Type GetTypeFromHandle(RuntimeTypeHandle handle) => Type.GetTypeFromHandle(handle);
        ...
        public override FieldInfo GetFieldFromHandle(RuntimeFieldHandle handle) => FieldInfo.GetFieldFromHandle(handle);
        ...
        public override FieldInfo GetFieldFromHandle(RuntimeFieldHandle handle, RuntimeTypeHandle declaringType) => FieldInfo.GetFieldFromHandle(handle, declaringType);
        ...
        public override MethodBase GetMethodFromHandle(RuntimeMethodHandle handle) => MethodBase.GetMethodFromHandle(handle);
        ...
        public override IEnumerable<TypeInfo> GetDefinedTypes(Assembly assembly) => assembly.DefinedTypes;
        ...
        public override long GetHostContext(Assembly assembly) => assembly.HostContext;
        ...
        public override string GetImageRuntimeVersion(Assembly assembly) => assembly.ImageRuntimeVersion;
        ...
        public override bool IsDynamic(Assembly assembly) => assembly.IsDynamic;
        ...
        public override bool IsFullyTrusted(Assembly assembly) => assembly.IsFullyTrusted;
        ...
        public override string GetLocation(Assembly assembly) => assembly.Location;
        ...
        public override bool GetReflectionOnly(Assembly assembly) => assembly.ReflectionOnly;
        ...
        public override SecurityRuleSet GetSecurityRuleSet(Assembly assembly) => assembly.SecurityRuleSet;
        ...
        public override void AddModuleResolve(Assembly assembly, ModuleResolveEventHandler handler) => assembly.ModuleResolve += handler;
        ...
        /// <remarks>Occurs when the common language runtime class loader cannot resolve a reference to an internal module of an assembly through normal means.</remarks>
        public override void RemoveModuleResolve(Assembly assembly, ModuleResolveEventHandler handler) => assembly.ModuleResolve -= handler;
        ...
        public override object CreateInstance(Assembly assembly, string typeName, bool ignoreCase, BindingFlags bindingAttr, Binder binder, object[] args, CultureInfo culture, object[] activationAttributes) => assembly.CreateInstance(typeName, ignoreCase, bindingAttr, binder, args, culture, activationAttributes);
        ...
        public override IReadOnlyList<object> GetCustomAttributes(Assembly assembly, bool inherit) => assembly.GetCustomAttributes(inherit);
        ...
        public override IReadOnlyList<object> GetCustomAttributes(Assembly assembly, Type attributeType, bool inherit) => assembly.GetCustomAttributes(attributeType, inherit);
        ...
        public override IEnumerable<CustomAttributeData> GetCustomAttributesData(Assembly assembly) => assembly.GetCustomAttributesData();
        ...
        public override IReadOnlyList<Type> GetExportedTypes(Assembly assembly) => assembly.GetExportedTypes();
        ...
        public override FileStream GetFile(Assembly assembly, string name) => assembly.GetFile(name);
        ...
        public override IReadOnlyList<FileStream> GetFiles(Assembly assembly, bool getResourceModules) => assembly.GetFiles(getResourceModules);
        ...
        public override IReadOnlyList<Module> GetLoadedModules(Assembly assembly, bool getResourceModules) => assembly.GetLoadedModules();
        ...
        public override ManifestResourceInfo GetManifestResourceInfo(Assembly assembly, string resourceName) => assembly.GetManifestResourceInfo(resourceName);
        ...
        public override IReadOnlyList<string> GetManifestResourceNames(Assembly assembly) => assembly.GetManifestResourceNames();
        ...
        public override Stream GetManifestResourceStream(Assembly assembly, Type type, string name) => assembly.GetManifestResourceStream(type, name);
        ...
        /// <param name="name">The case-sensitive name of the manifest resource being requested. </param>
        /// <returns>The manifest resource; or null if no resources were specified during compilation or if the resource is not visible to the caller.</returns>
        public override Stream GetManifestResourceStream(Assembly assembly, string name) => assembly.GetManifestResourceStream(name);
        ...
        public override Module GetModule(Assembly assembly, string name) => assembly.GetModule(name);
        ...
        /// <param name="getResourceModules">true to include resource modules; otherwise, false.</param>
        /// <returns>An array of modules.</returns>
        public override IReadOnlyList<Module> GetModules(Assembly assembly, bool getResourceModules) => assembly.GetModules(getResourceModules);
        ...
        public override AssemblyName GetName(Assembly assembly, bool copiedName) => assembly.GetName(copiedName);
        ...
        public override IReadOnlyList<AssemblyName> GetReferencedAssemblies(Assembly assembly) => assembly.GetReferencedAssemblies();
        ...
        public override Assembly GetSatelliteAssembly(Assembly assembly, CultureInfo culture) => assembly.GetSatelliteAssembly(culture);
        ...
        /// <returns>The specified satellite assembly.</returns>
        public override Assembly GetSatelliteAssembly(Assembly assembly, CultureInfo culture, Version version) => assembly.GetSatelliteAssembly(culture, version);
        ...
        public override Type GetType(Assembly assembly, string name, bool throwOnError, bool ignoreCase) => assembly.GetType(name, throwOnError, ignoreCase);
        ...
        public override IReadOnlyList<Type> GetTypes(Assembly assembly) => assembly.GetTypes();
        ...
        public override bool IsDefined(Assembly assembly, Type attributeType, bool inherit) => assembly.IsDefined(attributeType, inherit);
        ...
        public override Assembly GetAssembly(Module module) => module.Assembly;
        ...
        public override string GetFullyQualifiedName(Module module) => module.FullyQualifiedName;
        ...
        public override int GetMDStreamVersion(Module module) => module.MDStreamVersion;
        ...
        public override int GetMetadataToken(Module module) => module.MetadataToken;
        ...
        public override ModuleHandle GetModuleHandle(Module module) => module.ModuleHandle;
        ...
        public override Guid GetModuleVersionId(Module module) => module.ModuleVersionId;
        ...
        public override string GetName(Module module) => module.Name;
        ...
        public override string GetScopeName(Module module) => module.ScopeName;
        ...
        /// Please ensure that <see cref="FindTypes(Module, TypeFilter, object)"/> and <see cref="GetTypes(Module)"/> have consistent behavior.
        /// When overriding this method, make sure that similar methods provide consistent results.
        /// </remarks>
        public override IReadOnlyList<Type> FindTypes(Module module, TypeFilter filter, object filterCriteria) => module.FindTypes(filter, filterCriteria);
        ...
        public override IReadOnlyList<object> GetCustomAttributes(Module module, bool inherit) => module.GetCustomAttributes(inherit);
        ...
        public override IReadOnlyList<object> GetCustomAttributes(Module module, Type attributeType, bool inherit) => module.GetCustomAttributes(attributeType, inherit);
        ...
        public override IEnumerable<CustomAttributeData> GetCustomAttributesData(Module module) => module.GetCustomAttributesData();
        ...
        public override FieldInfo GetField(Module module, string name, BindingFlags bindingAttr) => module.GetField(name, bindingAttr);
        ...
        public override IReadOnlyList<FieldInfo> GetFields(Module module, BindingFlags bindingFlags) => module.GetFields(bindingFlags);
        ...
        public override MethodInfo GetMethod(Module module, string name, BindingFlags bindingAttr, Binder binder, CallingConventions callConvention, Type[] types, ParameterModifier[] modifiers) => module.GetMethod(name, bindingAttr, binder, callConvention, types, modifiers);
        ...
        public override IReadOnlyList<MethodInfo> GetMethods(Module module, BindingFlags bindingFlags) => module.GetMethods(bindingFlags);
        ...
        public override Type GetType(Module module, string className, bool throwOnError, bool ignoreCase) => module.GetType(className, throwOnError, ignoreCase);
        ...
        /// When overriding this method, make sure that similar methods provide consistent results.
        /// </remarks>
        public override IReadOnlyList<Type> GetTypes(Module module) => module.GetTypes();
        ...
        public override bool IsDefined(Module module, Type attributeType, bool inherit) => module.IsDefined(attributeType, inherit);
        ...
        public override bool IsResource(Module module) => module.IsResource();
        ...
        public override FieldInfo ResolveField(Module module, int metadataToken, Type[] genericTypeArguments, Type[] genericMethodArguments) => module.ResolveField(metadataToken, genericTypeArguments, genericMethodArguments);
        ...
        public override MemberInfo ResolveMember(Module module, int metadataToken, Type[] genericTypeArguments, Type[] genericMethodArguments) => module.ResolveMember(metadataToken, genericTypeArguments, genericMethodArguments);
        ...
        public override MethodBase ResolveMethod(Module module, int metadataToken, Type[] genericTypeArguments, Type[] genericMethodArguments) => module.ResolveMethod(metadataToken, genericTypeArguments, genericMethodArguments);
        ...
        public override byte[] ResolveSignature(Module module, int metadataToken) => module.ResolveSignature(metadataToken);
        ...
        public override string ResolveString(Module module, int metadataToken) => module.ResolveString(metadataToken);
        ...
        public override Type ResolveType(Module module, int metadataToken, Type[] genericTypeArguments, Type[] genericMethodArguments) => module.ResolveType(metadataToken, genericTypeArguments, genericMethodArguments);
        ...
        public override Type GetReflectedType(MemberInfo member) => member.ReflectedType;
        ...
        public override bool IsDefined(MemberInfo member, Type attributeType, bool inherit) => member.IsDefined(attributeType, inherit);

        // NB: Find methods are implemented as virtualization over the underlying functionality rather than
        //     extension methods that use other provider members. While this makes overriding the behavior
        //     of a provider in a consistent manner a bit harder, it allows for proper caching as well. When
        //     someone overrides e.g. GetInterfaces or Get[Methods|Fields|...], they should also override
        //     the Find* methods.
        ...
        /// <remarks>
        /// Note to implementers:
        /// Please ensure that <see cref="FindInterfaces(Type, TypeFilter, object)"/> and <see cref="GetInterfaces(Type)"/> have consistent behavior.
        /// When overriding this method, make sure that similar methods provide consistent results.
        /// </remarks>
        public override IReadOnlyList<Type> FindInterfaces(Type type, TypeFilter filter, object filterCriteria) => type.FindInterfaces(filter, filterCriteria);
        ...
        /// <remarks>
        /// Note to implementers:
        /// Please ensure that <see cref="FindMembers(Type, MemberTypes, BindingFlags, MemberFilter, object)"/> and <see cref="GetFields(Type, BindingFlags)"/>, <see cref="GetMethods(Type, BindingFlags)"/>, <see cref="GetProperties(Type, BindingFlags)"/>, <see cref="GetEvents(Type, BindingFlags)"/>, and <see cref="GetConstructors(Type, BindingFlags)"/> have consistent behavior.
        /// When overriding this method, make sure that similar methods provide consistent results.
        /// </remarks>
        public override IReadOnlyList<MemberInfo> FindMembers(Type type, MemberTypes memberType, BindingFlags bindingAttr, MemberFilter filter, object filterCriteria) => type.FindMembers(memberType, bindingAttr, filter, filterCriteria);
        ...
        public override int GetArrayRank(Type type) => type.GetArrayRank();
        ...
        public override IReadOnlyList<MemberInfo> GetDefaultMembers(Type type) => type.GetDefaultMembers();
        ...
        public override Assembly GetAssembly(Type type) => type.Assembly;
        ...
        public override string GetAssemblyQualifiedName(Type type) => type.AssemblyQualifiedName;
        ...
        public override TypeAttributes GetAttributes(Type type) => type.Attributes;
        ...
        public override Type GetBaseType(Type type) => type.BaseType;
        ...
        public override bool ContainsGenericParameters(Type type) => type.ContainsGenericParameters;
        ...
        public override MethodBase GetDeclaringMethod(Type type) => type.DeclaringMethod;
        ...
        public override Type GetDeclaringType(Type type) => type.DeclaringType;
        ...
        public override string GetFullName(Type type) => type.FullName;
        ...
        public override GenericParameterAttributes GetGenericParameterAttributes(Type type) => type.GenericParameterAttributes;
        ...
        public override int GetGenericParameterPosition(Type type) => type.GenericParameterPosition;
        ...
        public override Guid GetGuid(Type type) => type.GUID;
        ...
        public override bool HasElementType(Type type) => type.HasElementType;
        ...
        public override bool IsCOMObject(Type type) => type.IsCOMObject;
        ...
        public override bool IsConstructedGenericType(Type type) => type.IsConstructedGenericType;
        ...
        public override bool IsContextful(Type type) => type.IsContextful;
        ...
        public override bool IsGenericParameter(Type type) => type.IsGenericParameter;
        ...
        public override bool IsGenericType(Type type) => type.IsGenericType;
        ...
        public override bool IsGenericTypeDefinition(Type type) => type.IsGenericTypeDefinition;
        ...
        public override bool IsMarshalByRef(Type type) => type.IsMarshalByRef;
        ...
        public override bool IsSecurityCritical(Type type) => type.IsSecurityCritical;
        ...
        public override bool IsSecuritySafeCritical(Type type) => type.IsSecuritySafeCritical;
        ...
        public override bool IsSecurityTransparent(Type type) => type.IsSecurityTransparent;
        ...
        public override Module GetModule(Type type) => type.Module;
        ...
        public override string GetNamespace(Type type) => type.Namespace;
        ...
        public override StructLayoutAttribute GetStructLayoutAttribute(Type type) => type.StructLayoutAttribute;
        ...
        public override RuntimeTypeHandle GetTypeHandle(Type type) => type.TypeHandle;
        ...
        public override Type GetUnderlyingSystemType(Type type) => type.UnderlyingSystemType;
        ...
        public override Delegate CreateDelegate(MethodInfo method, Type delegateType) => method.CreateDelegate(delegateType);
        ...
        public override Delegate CreateDelegate(MethodInfo method, Type delegateType, object target) => method.CreateDelegate(delegateType, target);
        ...
        public override object GetDefaultValue(ParameterInfo parameter) => parameter.DefaultValue;
        ...
        /// <param name="parameter">The parameter to get the default value for.</param>
        /// <returns>The default value of the parameter, or <see cref="DBNull.Value" /> if the parameter has no default value.</returns>
        public override object GetRawDefaultValue(ParameterInfo parameter) => parameter.RawDefaultValue;
        ...
        public override FieldAttributes GetAttributes(FieldInfo field) => field.Attributes;
        ...
        public override RuntimeFieldHandle GetFieldHandle(FieldInfo field) => field.FieldHandle;
        ...
        public override Type GetFieldType(FieldInfo field) => field.FieldType;
        ...
        public override bool IsSecurityCritical(FieldInfo field) => field.IsSecurityCritical;
        ...
        public override bool IsSecuritySafeCritical(FieldInfo field) => field.IsSecuritySafeCritical;
        ...
        public override bool IsSecurityTransparent(FieldInfo field) => field.IsSecurityTransparent;
        ...
        public override IReadOnlyList<Type> GetOptionalCustomModifiers(FieldInfo field) => field.GetOptionalCustomModifiers();
        ...
        public override IReadOnlyList<Type> GetRequiredCustomModifiers(FieldInfo field) => field.GetRequiredCustomModifiers();
        ...
        public override EventAttributes GetAttributes(EventInfo @event) => @event.Attributes;
        ...
        public override Type GetEventHandlerType(EventInfo @event) => @event.EventHandlerType;
        ...
        public override bool IsMulticast(EventInfo @event) => @event.IsMulticast;
        ...
        public override PropertyAttributes GetAttributes(PropertyInfo property) => property.Attributes;
        ...
        public override Type GetPropertyType(PropertyInfo property) => property.PropertyType;
        ...
        public override bool CanRead(PropertyInfo property) => property.CanRead;
        ...
        public override bool CanWrite(PropertyInfo property) => property.CanWrite;
        ...
        public override IEnumerable<CustomAttributeData> GetCustomAttributesData(MemberInfo member) => member.GetCustomAttributesData();
        ...
        public override IReadOnlyList<object> GetCustomAttributes(MemberInfo member, bool inherit) => member.GetCustomAttributes(inherit);
        ...
        public override IReadOnlyList<object> GetCustomAttributes(MemberInfo member, Type attributeType, bool inherit) => member.GetCustomAttributes(attributeType, inherit);
        ...
        public override Type GetDeclaringType(MemberInfo member) => member.DeclaringType;
        ...
        public override int GetMetadataToken(MemberInfo member) => member.MetadataToken;
        ...
        public override Module GetModule(MemberInfo member) => member.Module;
        ...
        public override string GetName(MemberInfo member) => member.Name;
        ...
        public override MethodAttributes GetAttributes(MethodBase method) => method.Attributes;
        ...
        public override CallingConventions GetCallingConvention(MethodBase method) => method.CallingConvention;
        ...
        public override MethodBody GetMethodBody(MethodBase method) => method.GetMethodBody();
        ...
        public override RuntimeMethodHandle GetMethodHandle(MethodBase method) => method.MethodHandle;
        ...
        public override MethodImplAttributes GetMethodImplementationFlags(MethodBase method) => method.GetMethodImplementationFlags();
        ...
        public override bool ContainsGenericParameters(MethodBase method) => method.ContainsGenericParameters;
        ...
        public override bool IsGenericMethod(MethodBase method) => method.IsGenericMethod;
        ...
        public override bool IsGenericMethodDefinition(MethodBase method) => method.IsGenericMethodDefinition;
        ...
        public override bool IsSecurityCritical(MethodBase method) => method.IsSecurityCritical;
        ...
        public override bool IsSecuritySafeCritical(MethodBase method) => method.IsSecuritySafeCritical;
        ...
        public override bool IsSecurityTransparent(MethodBase method) => method.IsSecurityTransparent;
        ...
        public override MethodInfo GetBaseDefinition(MethodInfo method) => method.GetBaseDefinition();
        ...
        public override ParameterAttributes GetAttributes(ParameterInfo parameter) => parameter.Attributes;
        ...
        public override IEnumerable<CustomAttributeData> GetCustomAttributesData(ParameterInfo parameter) => parameter.GetCustomAttributesData();
        ...
        public override IReadOnlyList<object> GetCustomAttributes(ParameterInfo parameter, bool inherit) => parameter.GetCustomAttributes(inherit);
        ...
        public override IReadOnlyList<object> GetCustomAttributes(ParameterInfo parameter, Type attributeType, bool inherit) => parameter.GetCustomAttributes(attributeType, inherit);
        ...
        public override bool HasDefaultValue(ParameterInfo parameter) => parameter.HasDefaultValue;
        ...
        public override bool IsDefined(ParameterInfo parameter, Type attributeType, bool inherit) => parameter.IsDefined(attributeType, inherit);
        ...
        public override MemberInfo GetMember(ParameterInfo parameter) => parameter.Member;
        ...
        public override int GetMetadataToken(ParameterInfo parameter) => parameter.MetadataToken;
        ...
        public override string GetName(ParameterInfo parameter) => parameter.Name;
        ...
        public override Type GetParameterType(ParameterInfo parameter) => parameter.ParameterType;
        ...
        public override int GetPosition(ParameterInfo parameter) => parameter.Position;
        ...
        public override IReadOnlyList<Type> GetOptionalCustomModifiers(ParameterInfo parameter) => parameter.GetOptionalCustomModifiers();
        ...
        public override IReadOnlyList<Type> GetRequiredCustomModifiers(ParameterInfo parameter) => parameter.GetRequiredCustomModifiers();
        ...
        public override void AddEventHandler(EventInfo @event, object target, Delegate handler) => @event.AddEventHandler(target, handler);
        ...
        public override IReadOnlyList<MethodInfo> GetAccessors(PropertyInfo property, bool nonPublic) => property.GetAccessors(nonPublic);
        ...
        public override MethodInfo GetAddMethod(EventInfo @event, bool nonPublic) => @event.GetAddMethod(nonPublic);
        ...
        public override object GetConstantValue(PropertyInfo property) => property.GetConstantValue();
        ...
        public override ConstructorInfo GetConstructor(Type type, BindingFlags bindingAttr, Binder binder, CallingConventions callConvention, Type[] types, ParameterModifier[] modifiers) => type.GetConstructor(bindingAttr, binder, callConvention, types, modifiers);
        ...
        /// <remarks>
        /// Note to implementers:
        /// Please ensure that <see cref="FindMembers(Type, MemberTypes, BindingFlags, MemberFilter, object)"/> and <see cref="GetConstructors(Type, BindingFlags)"/> have consistent behavior.
        /// When overriding this method, make sure that similar methods provide consistent results.
        /// </remarks>
        public override IReadOnlyList<ConstructorInfo> GetConstructors(Type type, BindingFlags bindingAttr) => type.GetConstructors(bindingAttr);
        ...
        public override Type GetElementType(Type type) => type.GetElementType();
        ...
        public override EventInfo GetEvent(Type type, string name, BindingFlags bindingAttr) => type.GetEvent(name, bindingAttr);
        ...
        /// <remarks>
        /// Note to implementers:
        /// Please ensure that <see cref="FindMembers(Type, MemberTypes, BindingFlags, MemberFilter, object)"/> and <see cref="GetEvents(Type, BindingFlags)"/> have consistent behavior.
        /// When overriding this method, make sure that similar methods provide consistent results.
        /// </remarks>
        public override IReadOnlyList<EventInfo> GetEvents(Type type, BindingFlags bindingAttr) => type.GetEvents(bindingAttr);
        ...
        public override FieldInfo GetField(Type type, string name, BindingFlags bindingAttr) => type.GetField(name, bindingAttr);
        ...
        /// <remarks>
        /// Note to implementers:
        /// Please ensure that <see cref="FindMembers(Type, MemberTypes, BindingFlags, MemberFilter, object)"/> and <see cref="GetFields(Type, BindingFlags)"/> have consistent behavior.
        /// When overriding this method, make sure that similar methods provide consistent results.
        /// </remarks>
        public override IReadOnlyList<FieldInfo> GetFields(Type type, BindingFlags bindingAttr) => type.GetFields(bindingAttr);
        ...
        public override IReadOnlyList<Type> GetGenericArguments(MethodInfo method) => method.GetGenericArguments();
        ...
        public override ParameterInfo GetReturnParameter(MethodInfo method) => method.ReturnParameter;
        ...
        public override Type GetReturnType(MethodInfo method) => method.ReturnType;
        ...
        public override ICustomAttributeProvider GetReturnTypeCustomAttributes(MethodInfo method) => method.ReturnTypeCustomAttributes;
        ...
        public override IReadOnlyList<Type> GetGenericArguments(Type type) => type.GetGenericArguments();
        ...
        public override MethodInfo GetGenericMethodDefinition(MethodInfo method) => method.GetGenericMethodDefinition();
        ...
        public override IReadOnlyList<Type> GetGenericParameterConstraints(Type type) => type.GetGenericParameterConstraints();
        ...
        public override Type GetGenericTypeDefinition(Type type) => type.GetGenericTypeDefinition();
        ...
        public override MethodInfo GetGetMethod(PropertyInfo property, bool nonPublic) => property.GetGetMethod(nonPublic);
        ...
        public override IReadOnlyList<ParameterInfo> GetIndexParameters(PropertyInfo property) => property.GetIndexParameters();
        ...
        public override IReadOnlyList<Type> GetOptionalCustomModifiers(PropertyInfo property) => property.GetOptionalCustomModifiers();
        ...
        public override IReadOnlyList<Type> GetRequiredCustomModifiers(PropertyInfo property) => property.GetRequiredCustomModifiers();
        ...
        public override Type GetInterface(Type type, string name, bool ignoreCase) => type.GetInterface(name, ignoreCase);
        ...
        public override IReadOnlyList<Type> GetInterfaces(Type type) => type.GetInterfaces();
        ...
        public override InterfaceMapping GetInterfaceMap(Type type, Type interfaceType) => type.GetInterfaceMap(interfaceType);
        ...
        public override IReadOnlyList<MemberInfo> GetMember(Type type, string name, MemberTypes memberTypes, BindingFlags bindingAttr) => type.GetMember(name, memberTypes, bindingAttr);
        ...
        /// <param name="modifiers">An array of <see cref="ParameterModifier" /> objects representing the attributes associated with the corresponding element in the <paramref name="types" /> array. The default binder does not process this parameter.</param>
        /// <returns>An object representing the method that matches the specified requirements, if found; otherwise, null.</returns>
        public override MethodInfo GetMethod(Type type, string name, BindingFlags bindingAttr, Binder binder, CallingConventions callConvention, Type[] types, ParameterModifier[] modifiers) => type.GetMethod(name, bindingAttr, binder, callConvention, types, modifiers);
        ...
        /// <param name="bindingAttr">A bitmask comprised of one or more <see cref="BindingFlags" /> that specify how the search is conducted.</param>
        /// <returns>An object representing the method that matches the specified requirements, if found; otherwise, null.</returns>
        public override MethodInfo GetMethod(Type type, string name, BindingFlags bindingAttr) => type.GetMethod(name, bindingAttr);
        ...
        /// <remarks>
        /// Note to implementers:
        /// Please ensure that <see cref="FindMembers(Type, MemberTypes, BindingFlags, MemberFilter, object)"/> and <see cref="GetMethods(Type, BindingFlags)"/> have consistent behavior.
        /// When overriding this method, make sure that similar methods provide consistent results.
        /// </remarks>
        public override IReadOnlyList<MethodInfo> GetMethods(Type type, BindingFlags bindingAttr) => type.GetMethods(bindingAttr);
        ...
        public override Type GetNestedType(Type type, string name, BindingFlags bindingAttr) => type.GetNestedType(name, bindingAttr);
        ...
        public override IReadOnlyList<Type> GetNestedTypes(Type type, BindingFlags bindingAttr) => type.GetNestedTypes(bindingAttr);
        ...
        public override IReadOnlyList<MethodInfo> GetOtherMethods(EventInfo @event, bool nonPublic) => @event.GetOtherMethods();
        ...
        public override IReadOnlyList<ParameterInfo> GetParameters(MethodBase method) => method.GetParameters();
        ...
        public override IReadOnlyList<PropertyInfo> GetProperties(Type type, BindingFlags bindingAttr) => type.GetProperties(bindingAttr);
        ...
        public override PropertyInfo GetProperty(Type type, string name, BindingFlags bindingAttr, Binder binder, Type returnType, Type[] types, ParameterModifier[] modifiers) => type.GetProperty(name, bindingAttr, binder, returnType, types, modifiers);
        ...
        /// <param name="bindingAttr">A bitmask comprised of one or more <see cref="BindingFlags" /> that specify how the search is conducted.</param>
        /// <returns>An object representing the property that matches the specified requirements, if found; otherwise, null.</returns>
        public override PropertyInfo GetProperty(Type type, string name, BindingFlags bindingAttr) => type.GetProperty(name, bindingAttr);
        ...
        /// <param name="returnType">The return type of the property.</param>
        /// <returns>An object representing the property that matches the specified requirements, if found; otherwise, null.</returns>
        public override PropertyInfo GetProperty(Type type, string name, Type returnType) => type.GetProperty(name, returnType);
        ...
        public override MethodInfo GetRaiseMethod(EventInfo @event, bool nonPublic) => @event.GetRaiseMethod(nonPublic);
        ...
        public override object GetRawConstantValue(FieldInfo field) => field.GetRawConstantValue();
        ...
        /// <param name="property">The property for which to get the literal value.</param>
        /// <returns>An object that contains the literal value associated with the property. If the literal value is a class type with an element value of zero, the return value is null.</returns>
        public override object GetRawConstantValue(PropertyInfo property) => property.GetRawConstantValue();
        ...
        public override MethodInfo GetRemoveMethod(EventInfo @event, bool nonPublic) => @event.GetRemoveMethod(nonPublic);
        ...
        public override MethodInfo GetSetMethod(PropertyInfo property, bool nonPublic) => property.GetSetMethod(nonPublic);
        ...
        public override object GetValue(FieldInfo field, object obj) => field.GetValue(obj);
        ...
        public override object GetValue(PropertyInfo property, object obj, BindingFlags invokeAttr, Binder binder, object[] index, CultureInfo culture) => property.GetValue(obj, invokeAttr, binder, index, culture);
        ...
        public override object Invoke(ConstructorInfo constructor, BindingFlags invokeAttr, Binder binder, object[] parameters, CultureInfo culture) => constructor.Invoke(invokeAttr, binder, parameters, culture);
        ...
        public override object Invoke(MethodBase method, object obj, BindingFlags invokeAttr, Binder binder, object[] parameters, CultureInfo culture) => method.Invoke(obj, invokeAttr, binder, parameters, culture);
        ...
        public override object InvokeMember(Type type, string name, BindingFlags invokeAttr, Binder binder, object target, object[] args, ParameterModifier[] modifiers, CultureInfo culture, string[] namedParameters) => type.InvokeMember(name, invokeAttr, binder, target, args, modifiers, culture, namedParameters);
        ...
        public override bool IsArray(Type type) => type.IsArray;
        ...
        public override bool IsByRef(Type type) => type.IsByRef;
        ...
        public override bool IsInterface(Type type) => type.IsInterface;
        ...
        public override bool IsPointer(Type type) => type.IsPointer;
        ...
        public override bool IsPrimitive(Type type) => type.IsPrimitive;
        ...
        public override bool IsValueType(Type type) => type.IsValueType;
        ...
        public override bool IsVisible(Type type) => type.IsVisible;
        ...
        public override bool IsAssignableFrom(Type type, Type c) => type.IsAssignableFrom(c);
        ...
        public override bool IsEquivalentTo(Type type, Type other) => type.IsEquivalentTo(other);
        ...
        public override bool IsInstanceOfType(Type type, object o) => type.IsInstanceOfType(o);
        ...
        public override bool IsSubclassOf(Type type, Type c) => type.IsSubclassOf(c);
        ...
        public override Type MakeArrayType(Type elementType) => elementType.MakeArrayType();
        ...
        public override Type MakeArrayType(Type elementType, int rank) => elementType.MakeArrayType(rank);
        ...
        public override Type MakeByRefType(Type elementType) => elementType.MakeByRefType();
        ...
        public override MethodInfo MakeGenericMethod(MethodInfo genericMethodDefinition, params Type[] typeArguments) => genericMethodDefinition.MakeGenericMethod(typeArguments);
        ...
        public override Type MakeGenericType(Type genericTypeDefinition, params Type[] typeArguments) => genericTypeDefinition.MakeGenericType(typeArguments);
        ...
        public override Type MakePointerType(Type elementType) => elementType.MakePointerType();
        ...
        public override void RemoveEventHandler(EventInfo @event, object target, Delegate handler) => @event.RemoveEventHandler(target, handler);
        ...
        /// <param name="binder">A <see cref="Binder"/> that defines a set of properties and enables the binding, coercion of argument types, and invocation of members using reflection. If binder is null, then <see cref="Type.DefaultBinder"/> is used.</param>
        /// <param name="culture">A <see cref="CultureInfo"/> used to govern the coercion of types. If this is null, the <see cref="CultureInfo"/> for the current thread is used.</param>
        public override void SetValue(FieldInfo field, object obj, object value, BindingFlags invokeAttr, Binder binder, CultureInfo culture) => field.SetValue(obj, value, invokeAttr, binder, culture);
        ...
        /// <param name="index">Optional index values for indexed properties. This value should be null for non-indexed properties.</param>
        /// <param name="culture">A <see cref="CultureInfo"/> used to govern the coercion of types. If this is null, the <see cref="CultureInfo"/> for the current thread is used.</param>
        public override void SetValue(PropertyInfo property, object obj, object value, BindingFlags invokeAttr, Binder binder, object[] index, CultureInfo culture) => property.SetValue(obj, value, invokeAttr, binder, index, culture);
    }
}
