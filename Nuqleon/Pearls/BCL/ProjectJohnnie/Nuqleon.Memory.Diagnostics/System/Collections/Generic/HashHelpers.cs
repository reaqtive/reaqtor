...
//
// NB: The code in this file is copied from the github.com/dotnet/corefx code.
//
...
namespace System.Collections
{
    internal static class HashHelpers
    {
        ...
        {
            if (min < 0)
                throw new ArgumentException("The specified value should be greater than or equal to 0.");
