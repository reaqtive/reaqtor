...
namespace System.Linq.Expressions.Tests
{
    internal class LocalsSignatureParser : SigParser
    {
        ...
        private sealed class TypeCreator
        {
            ...
            private sealed class SimpleInner : Inner
            {
            ...
            private sealed class SzArrayInner : Inner
            {
                public override void Done(ITypeFactory factory, Stack<Type> stack)
                {
            ...
            private sealed class ArrayInner : Inner
            {
            ...
            private sealed class ByRefInner : Inner
            {
                public override void Done(ITypeFactory factory, Stack<Type> stack)
                {
            ...
            private sealed class PointerInner : Inner
            {
                public override void Done(ITypeFactory factory, Stack<Type> stack)
                {
            ...
            private sealed class TypeInner : Inner
            {
                private Type _type;
            ...
            private sealed class GenericInner : Inner
            {
