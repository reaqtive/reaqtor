...
{
    /// <summary>
    /// Thunk factory for thunks that initially interpret expression trees and then switch to compilation if sufficient
    /// invocations are made.
    /// </summary>
    internal sealed class TieredCompilationThunkFactory : ThunkFactoryBase
    {
        /// <summary>
        ...
        {
            return TieredCompliationThunks.TypeMap.TryGetValue(delegateType, out thunkType);
        }
    }
}
